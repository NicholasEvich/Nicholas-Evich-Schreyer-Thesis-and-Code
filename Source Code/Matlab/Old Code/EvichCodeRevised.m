...
inlet_diameter = linspace(0.05,0.1,31);
% inlet_diameter = 0.01;
% Pipe angle in degrees
% pipe_angle = 0;
% pipe_angle = 0:5:45;
% pipe_angle = linspace(0, 15, 21);
pipe_angle = linspace(0,15,100);
% pipe_angle = 0;
% heat_input = 500000;
% heat_input = 500;
% heat_input = 500;
% heat_input = 500000;
% heat_input = linspace(500,500000, 30);
        ...
        for k = 1:length(inlet_diameter)
            ...
            for m = 1:length(heat_input)
                ...
                for n = 2:length(z)
                    ...
                    alpha(i,j,k,m,n) = 1/(1 + RHO_v/RHO_f*(1 - quality(i,j,k,m,n))/quality(i,j,k,m,n));
